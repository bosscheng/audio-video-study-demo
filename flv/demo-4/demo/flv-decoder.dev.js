	...
	var FlvDemuxer = /*#__PURE__*/function (_Emitter) {
	  ...
	  _createClass(FlvDemuxer, [{
	    ...
	    value: function dispatch(data) {
	      ...
	      if (this.tempBuffer) {
	        var newBuffer = new Uint8Array(this.tempBuffer.byteLength + data.byteLength);
	      ...
	      while (true) {
	        ...
	        if (this.state === FLV_PARSE_STATE.init) {
	          ...
	          console.log("nextLength is ".concat(payloadLen, " and next state is FLV_PARSE_STATE.body"));
